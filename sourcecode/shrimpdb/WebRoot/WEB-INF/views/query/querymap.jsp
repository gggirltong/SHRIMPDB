...
<div  class="dev_one">
	<table>
	<tr>
    <td width="600" style="padding-left:36px;">Gis-query  distribution of own sample data</td>	
    <td  width="100">  
	<input id="showall"style="height:30px;width:120px;" type="button" value="show distribution">	
