...
<!--第二步：添加如下 HTML 代码-->
	...
	<table>
	<tr>
	            <td width="200" style="padding-left:36px;">data management</td>
	            <td width="150"style="padding-left:200px;"><a href="${ctx}/upload/metaupload">Add-data</a></td>  
	            <td  width="200"style="padding-left:50px;"><a href="${ctx}/query/mapperson">Gis-distribution</a></td>
	              		        									
                <td width="200"style="padding-left:50px;"><a href="${ctx}/query/openlist">Data-open</a></td>    		        									
...
option = {
    ...
    legend: {
        data:['U concentration','Th concentration']
    },
    grid: {
        left: '3%',
        right: '4%',
